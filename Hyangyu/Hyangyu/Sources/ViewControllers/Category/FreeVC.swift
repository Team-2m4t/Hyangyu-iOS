...
class FreeVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        registerXib()
        getCategory(order: "free", page: currentPage)
    }
    
    func registerXib() {
        let nibName = UINib(nibName: "CategoryCollectionViewCell", bundle: nil)
        freeCollectionView.register(nibName, forCellWithReuseIdentifier: "CategoryCollectionViewCell")
    }
    ...
    private func updateData(display: CagetoryDisplayResponse) {
        ...
        freeCollectionView.reloadData()
    }
}

extension FreeVC : UICollectionViewDataSource
{
...
extension FreeVC : UICollectionViewDelegateFlowLayout
{
    /*
