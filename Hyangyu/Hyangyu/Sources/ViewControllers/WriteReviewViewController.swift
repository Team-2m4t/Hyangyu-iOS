...
extension WriteReviewViewController : UITextViewDelegate {
    ...
    func textViewDidChange(_ textView: UITextView) {
        ...
        attributedString.addAttribute(.foregroundColor, value: UIColor.green, range: ("\(activityTextView.text.count)/150" as NSString).range(of:"\(activityTextView.text.count)"))
